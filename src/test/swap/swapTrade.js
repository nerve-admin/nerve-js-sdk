...
// 账户信息
let fromAddress = "NERVEepb6EWVjK5zLyV3VNqKtP3A1dYhvDcNK4";
let pri = '';
let amountIn = "10000000";// 卖出的资产数量
// let tokenPath = [nerve.swap.token(5, 1), nerve.swap.token(5, 1), nerve.swap.token(5, 1)];// 币币交换资产路径，路径中最后一个资产，是用户要买进的资产
let tokenPath = [nerve.swap.token(1, 1), nerve.swap.token(9, 1)];// 币币交换资产路径，路径中最后一个资产，是用户要买进的资产
let amountOutMin = "0";// 最小买进的资产数量
let feeTo = null;// 交易手续费取出一部分给指定的接收地址
let deadline = nerve.swap.currentTime() + 300;// 过期时间
let toAddress = "NERVEepb6EWVjK5zLyV3VNqKtP3A1dYhvDcNK4";// 资产接收地址
